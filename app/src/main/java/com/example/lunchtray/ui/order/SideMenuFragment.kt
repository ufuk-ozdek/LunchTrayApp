...
class SideMenuFragment : Fragment() {
    ...
    fun goToNextScreen() {
        ...
        this.findNavController().navigate(SideMenuFragmentDirections.actionSideMenuFragmentToAccompanimentMenuFragment())
    }
    ...
    fun cancelOrder() {
        ...
        this.findNavController().navigate(SideMenuFragmentDirections.actionSideMenuFragmentToStartOrderFragment())
    }
