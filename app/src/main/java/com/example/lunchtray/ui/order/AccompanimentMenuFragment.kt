...
class AccompanimentMenuFragment : Fragment() {
    ...
    fun goToNextScreen() {
        ...
        this.findNavController().navigate(AccompanimentMenuFragmentDirections.actionAccompanimentMenuFragmentToCheckoutFragment())
    }
    ...
    fun cancelOrder() {
        ...
        this.findNavController().navigate(AccompanimentMenuFragmentDirections.actionAccompanimentMenuFragmentToStartOrderFragment())
    }
