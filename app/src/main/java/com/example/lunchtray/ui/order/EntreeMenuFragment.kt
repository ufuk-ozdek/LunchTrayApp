...
class EntreeMenuFragment : Fragment() {
    ...
    fun goToNextScreen() {
        ...
        this.findNavController().navigate(EntreeMenuFragmentDirections.actionEntreeMenuFragmentToSideMenuFragment())
    }
    ...
    fun cancelOrder() {
        ...
        this.findNavController().navigate(EntreeMenuFragmentDirections.actionEntreeMenuFragmentToStartOrderFragment())
    }
